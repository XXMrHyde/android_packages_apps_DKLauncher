...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.darkkat.dklauncher.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.darkkat.dklauncher.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.darkkat.dklauncher.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.darkkat.dklauncher.compat.PackageInstallerCompatV16.queue"));
}
